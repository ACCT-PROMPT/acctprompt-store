...
export default function AuthModal({ onClose }: Props) {
  ...
  async function handleForgotSubmit(e: React.FormEvent) {
    ...
    setNotice('ถ้าอีเมลนี้มีในระบบ เราได้ส่งลิงก์ตั้งรหัสผ่านใหม่ไปให้แล้ว กรุณาเช็คกล่องจดหมาย (รวม Junk/Spam)');
  }
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
            ...
            {tab === 'login' && (
              <button
                ...
                className="text-xs font-semibold text-brand-700 text-right -mt-1.5"
              >
                ลืมรหัสผ่าน?
              </button>
            )}
